...
{
    unsigned long ept_to_create_addr;
    unsigned long ept_to_ack_addr;
...
{
    unsigned long ept_to_destroy_addr;
    unsigned long ept_to_ack_addr;
...
{
    unsigned long responder_ept_addr;
    int buffer_size;
